...
// these are additional namespaces i needed
// mainly for exceptions and other objects, eg. properties
...
namespace diagnosticSimulationClasses
{
    /// <summary>
    ...
    public abstract class diagnosticSimulation : ParameterSetCollection,
        IEventfulSimulation
    {
        /// <inheritdoc/>
        ...
        protected diagnosticSimulation(string name)
        {
