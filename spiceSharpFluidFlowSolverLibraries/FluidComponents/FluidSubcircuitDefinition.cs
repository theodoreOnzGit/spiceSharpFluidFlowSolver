...
namespace SpiceSharp.Components
{
    ...
    public class FluidSubcircuitDefinition : 
		IFluidSubcircuitDefinition
    {
        ...
        public FluidSubcircuitDefinition(IEntityCollection entities, 
				params string[] pins)
        {
        ...
        /// <inheritdoc/>
        public IFluidSubcircuitDefinition Clone()
            => new FluidSubcircuitDefinition(Entities.Clone(), Pins.ToArray());
    }
}
