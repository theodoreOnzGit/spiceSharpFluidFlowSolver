...
using SpiceSharp.Components.BasePipeBehaviors;
...
namespace SpiceSharp.Components
{
    ...
    public class BasePipe : Component,
        IParameterized<BaseParameters>
    {
		...
		// copied this from the nonlinear resistor, don't change!
        public BasePipe(string name, string nodeA, string nodeB) : base(name, 2)
        {
            Connect(nodeA, nodeB);
        }
		...
		// node A to B
        public BasePipe(string name) : base(name, 2){
