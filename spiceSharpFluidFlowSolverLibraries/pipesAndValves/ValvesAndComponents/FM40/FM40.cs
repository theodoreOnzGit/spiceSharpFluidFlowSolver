...
using SpiceSharp.Components.FM40Behaviors;
...
namespace SpiceSharp.Components
{
        ...
        IParameterized<BaseParameters>
    {
		...
		// copied this from the nonlinear resistor, don't change!
        public FM40(string name, string nodeA, string nodeB) : base(name, 2)
        {
            Connect(nodeA, nodeB);
        }
		...
		// node A to B
        public FM40(string name) : base(name, 2){
