...
namespace SpiceSharp.Components
{
    ...
    public class therminolPipe34 : Component,
        IParameterized<BaseParameters>
    {
		...
		// copied this from the nonlinear resistor, don't change!
        public therminolPipe34(string name, string nodeA, string nodeB) : base(name, 2)
        {
            Connect(nodeA, nodeB);
        }
		...
		// node A to B
        public therminolPipe34(string name) : base(name, 2){
